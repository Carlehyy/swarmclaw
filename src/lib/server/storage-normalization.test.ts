...
describe('storage-normalization', () => {
  ...
  describe('agents', () => {
    it('adds default capabilities, delegation, role, orgChart fields', () => {
      ...
      const result = normalizeStoredRecord('agents', agent, noopLoader) as Record<string, unknown>
  ...
  describe('sessions', () => {
    it('type migration orchestrated → delegated', () => {
      ...
      const result = normalizeStoredRecord('sessions', session, noopLoader) as Record<string, unknown>
  ...
  describe('schedules', () => {
    it('type resolution from scheduleType', () => {
      ...
      const result = normalizeStoredRecord('schedules', schedule, noopLoader) as Record<string, unknown>
  ...
  describe('tasks', () => {
    it('subtaskIds default to empty array', () => {
      ...
      const result = normalizeStoredRecord('tasks', task, noopLoader) as Record<string, unknown>
  ...
  describe('missions', () => {
    it('defaults status/phase/sourceRef', () => {
      ...
      const result = normalizeStoredRecord('missions', mission, noopLoader) as Record<string, unknown>
      assert.equal(result.status, 'active')
  ...
  describe('delegation_jobs', () => {
    it('missionId cleanup', () => {
      ...
      const result = normalizeStoredRecord('delegation_jobs', job, noopLoader) as Record<string, unknown>
