...
// ---------------------------------------------------------------------------
// Provider Capability Descriptions (re-exported)
// ---------------------------------------------------------------------------

// Re-export clients-side safe exports from a dedicated module to avoid
// importing Node.js built-ins in the browser bundle.
export { CLI_PROVIDER_CAPABILITIES, isCliProvider } from './cli-provider-ids'
